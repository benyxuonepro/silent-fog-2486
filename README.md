...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/silent-fog-2486
```

A live public deployment of this template is available at [https://silent-fog-2486.templates.workers.dev](https://silent-fog-2486.templates.workers.dev)
